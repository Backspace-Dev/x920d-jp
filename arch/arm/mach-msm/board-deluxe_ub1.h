...
#define CHG_WDT_EN_XA_XB	GPIO(3)
#define POGO_ID_XC		GPIO(3)
...
#define OneSEG_INTz_XA          GPIO(67)
#define WIFI_SD_CLK		GPIO(68)
#define MCAM_D1V2_EN_XC         GPIO(69)
*/
//
#define TS_CLK_XA               GPIO(55)
#define TS_EN_XA                GPIO(56)
#define TS_DATA_XA              GPIO(57)
#define WCN_PRIORITY_XA         GPIO(58)
#define AP2MDM_PON_RESET_N_XA   GPIO(59)
#define MDM_LTE_FRAME_SYNC_XA   GPIO(60)
#define MDM_LTE_ACTIVE_XA       GPIO(61)
#define TS_SYNC_XA              GPIO(62)
#define WCN_PRIORITY_XB         GPIO(55)
#define MDM_LTE_ACTIVE_XB       GPIO(56)
#define MDM_LTE_FRAME_SYNC_XB   GPIO(57)
#define TS_SYNC_XB              GPIO(58)
#define TS_CLK_XB               GPIO(59)
#define TS_EN_XB                GPIO(60)
#define TS_DATA_XB              GPIO(61)
#define AP2MDM_PON_RESET_N_XB   GPIO(62)

#define RAW_INT0_XC             GPIO(55)
#define RAW_INT1_XC             GPIO(56)
#define AP2MDM_WAKEUP_XC        GPIO(57)

#define RAW_INT0		GPIO(63)
// #define WIFI_SD_D3_XC		GPIO(63)
#define WIFI_SD_D3		GPIO(63)
#define APQ2MDM_IPC3		GPIO(64)
// #define WIFI_SD_D2_XC		GPIO(64)
#define WIFI_SD_D2		GPIO(64)
#define RAW_INT1		GPIO(65)
// #define WIFI_SD_D1_XC		GPIO(65)
#define WIFI_SD_D1		GPIO(65)
#define AP2MDM_WAKEUP_XA_XB	GPIO(66)
// #define WIFI_SD_D0_XC		GPIO(66)
#define WIFI_SD_D0		GPIO(66)
#define OneSEG_INTz_XA          GPIO(67)
#define MCAM_D1V2_EN_XB         GPIO(67)
#define MCAM_D1V2_EN_XC         GPIO(69)
// #define WIFI_SD_CMD_XC         GPIO(67)
#define WIFI_SD_CMD         GPIO(67)
#define APQ2MDM_IPC2		GPIO(68)
// #define WIFI_SD_CLK_XC		GPIO(68)
#define WIFI_SD_CLK		GPIO(68)
...
#define POGO_ID_XA_XB		PMGPIO(24)
...
#define BCM4330_SLEEP_CLK_XA    PMGPIO(44)
#define OneSEG_INTz_XB          PMGPIO(44)
